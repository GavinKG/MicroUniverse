...
Shader "MicroUniverse/Lit"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 _ObjectCenterWS;
			half _DarkenDiffuseGrayscale;
			half _Smoothness;
			half _SpecularIntensity;
			half _JSMaxDistance;
			half _JSIntensity;
			half _VerticalAORadius;
			half _VerticalAOIntensity;
			half _FloorAOIntensity;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 temp_output_68_0 = ( _MainLightColor.rgb * ase_lightAtten );
				float4 screenPos = IN.ase_texcoord3;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				half2 appendResult296 = (half2(ase_screenPosNorm.x , ase_screenPosNorm.y));
				half DarkMask285 = tex2D( DarkMaskTex, appendResult296 ).r;
				#ifdef _DARKMASK_ON
				half3 staticSwitch288 = ( temp_output_68_0 * DarkMask285 );
				#else
				half3 staticSwitch288 = temp_output_68_0;
				#endif
				half3 LightAtten74 = staticSwitch288;
				...
				half3 worldNormal108 = normalize( float3(dot(tanToWorld0,tanNormal108), dot(tanToWorld1,tanNormal108), dot(tanToWorld2,tanNormal108)) );
				#ifdef _FLIPNORMAL_ON
				half3 staticSwitch77 = ( worldNormal108 * float3( -1,-1,-1 ) );
				#else
				half3 staticSwitch77 = worldNormal108;
				#endif
				half3 NormalWS78 = staticSwitch77;
				half dotResult84 = dot( _MainLightPosition.xyz , NormalWS78 );
				half NdotL66 = max( dotResult84 , 0.0 );
				half3 bakedGI85 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, ase_worldNormal);
				half4 temp_cast_0 = (1.0).xxxx;
				half2 uv0191 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				#ifdef _DIFFUSEUSETEX_ON
				half4 staticSwitch322 = tex2D( _DiffuseTex, uv0191 );
				#else
				half4 staticSwitch322 = temp_cast_0;
				#endif
				half4 temp_cast_1 = (1.0).xxxx;
				half2 uv06_g54 = float4(IN.ase_texcoord8.xy,0,0).xy * float2( 1,1 ) + float2( 0,0 );
				half2 break7_g54 = uv06_g54;
				half temp_output_8_0_g54 = step( break7_g54.x , 0.5 );
				half temp_output_11_0_g54 = ( 1.0 - temp_output_8_0_g54 );
				half temp_output_9_0_g54 = step( break7_g54.y , 0.5 );
				half temp_output_10_0_g54 = ( 1.0 - temp_output_9_0_g54 );
				#ifdef _DIFFUSEUSEFOURGRID_ON
				half4 staticSwitch325 = ( ( temp_output_11_0_g54 * temp_output_10_0_g54 * _NW ) + ( temp_output_8_0_g54 * temp_output_10_0_g54 * _NE ) + ( temp_output_8_0_g54 * temp_output_9_0_g54 * _SE ) + ( temp_output_11_0_g54 * temp_output_9_0_g54 * _SW ) );
				#else
				half4 staticSwitch325 = temp_cast_1;
				#endif
				half4 Albedo315 = ( _Diffuse * staticSwitch322 * staticSwitch325 );
				half3 Diffuse221 = ( ( ( LightAtten74 * NdotL66 ) + bakedGI85 ) * (Albedo315).rgb );
				half lerpResult320 = lerp( 0.8 , 1.0 , NdotL66);
				half3 temp_cast_2 = (( _DarkenDiffuseGrayscale * lerpResult320 )).xxx;
				half3 lerpResult317 = lerp( temp_cast_2 , Diffuse221 , DarkMask285);
				#ifdef _DARKMASK_ON
				half3 staticSwitch308 = lerpResult317;
				#else
				half3 staticSwitch308 = Diffuse221;
				#endif
				half3 DarkenDiffuse310 = staticSwitch308;
				half3 normalizeResult104 = normalize( _MainLightPosition.xyz );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = normalize(ase_worldViewDir);
				half3 normalizeResult88 = normalize( ( normalizeResult104 + ase_worldViewDir ) );
				half3 HalfDir72 = normalizeResult88;
				half dotResult92 = dot( HalfDir72 , NormalWS78 );
				#ifdef _SPECULAR_ON
				half3 staticSwitch89 = ( LightAtten74 * pow( max( dotResult92 , 0.0001 ) , exp2( ( ( _Smoothness * 10.0 ) + 1.0 ) ) ) * _SpecularIntensity );
				#else
				half3 staticSwitch89 = float3( 0,0,0 );
				#endif
				half3 Specular225 = staticSwitch89;
				half3 temp_cast_3 = (0.0).xxx;
				#ifdef _DARKMASK_ON
				half3 staticSwitch312 = temp_cast_3;
				#else
				half3 staticSwitch312 = Specular225;
				#endif
				half3 DarkenSpecular314 = staticSwitch312;
				half3 WorldPosition8_g53 = WorldPosition;
				half3 localAdditionalLightsFlat8_g53 = AdditionalLightsFlat( WorldPosition8_g53 );
				half3 temp_output_124_0 = (_EmissionColor).rgb;
				half temp_output_125_0 = max( _JSMaxDistance , 0.001 );
				half clampResult123 = clamp( distance( _ObjectCenterWS , WorldPosition ) , 0.0 , temp_output_125_0 );
				#ifdef _JELLYSUBSURFACE_ON
				half3 staticSwitch118 = ( temp_output_124_0 * pow( ( 1.0 - ( clampResult123 / temp_output_125_0 ) ) , 2.0 ) * _JSIntensity );
				#else
				half3 staticSwitch118 = temp_output_124_0;
				#endif
				#ifdef _EMISSION_ON
				half3 staticSwitch114 = staticSwitch118;
				#else
				half3 staticSwitch114 = float3( 0,0,0 );
				#endif
				half3 Emission224 = staticSwitch114;
				half3 lerpResult281 = lerp( half3(0,0,0) , Emission224 , DarkMask285);
				#ifdef _DARKMASK_ON
				half3 staticSwitch267 = lerpResult281;
				#else
				half3 staticSwitch267 = Emission224;
				#endif
				half3 DarkenEmission269 = staticSwitch267;
				half temp_output_173_0 = ( WorldPosition.y * WorldPosition.y );
				#ifdef _VERTICALAO_ON
				half staticSwitch168 = ( 1.0 - ( ( 1.0 - ( temp_output_173_0 / ( temp_output_173_0 + _VerticalAORadius ) ) ) * _VerticalAOIntensity ) );
				#else
				half staticSwitch168 = 1.0;
				#endif
				half2 appendResult203 = (half2(WorldPosition.x , WorldPosition.z));
				half2 WorldUV262 = ( ( appendResult203 / CityWH ) + 0.5 );
				half clampResult214 = clamp( ( ( 1.0 - tex2D( FloorAO, WorldUV262 ).r ) * _FloorAOIntensity ) , 0.0 , 1.0 );
				#ifdef _FLOORAO_ON
				half staticSwitch194 = ( 1.0 - clampResult214 );
				#else
				half staticSwitch194 = 1.0;
				#endif
				half AO216 = ( staticSwitch168 * staticSwitch194 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( DarkenDiffuse310 + DarkenSpecular314 + localAdditionalLightsFlat8_g53 + DarkenEmission269 ) * AO216 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=18200
0;72.66667;1704;1287;8542.372;3679.917;6.222116;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;223;-3027.418,-795.7836;Inherit;False;2144.066;532.7998;Diffuse;8;221;188;86;189;101;100;85;71;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;276;-5236.427,-1030.819;Inherit;True;Global;DarkMaskTex;DarkMaskTex;25;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;168;-1593.086,1117.354;Inherit;False;Property;_VerticalAO;Vertical AO;18;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-2225.639,688.1677;Inherit;False;Property;_JSIntensity;JSIntensity;16;0;Create;True;0;0;False;0;False;1;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;97;-2363.676,38.29501;Inherit;False;Property;_Smoothness;Smoothness;10;0;Create;True;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;194;-1596.458,1574.993;Inherit;False;Property;_FloorAO;Floor AO;21;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;109;-5529.458,-626.2378;Inherit;False;Property;_Diffuse;Diffuse;0;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;329;-6080.042,-71.65796;Inherit;False;Property;_NE;NE;5;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;327;-6283.042,-71.65796;Inherit;False;Property;_NW;NW;4;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;324;-5817.042,-7.657959;Inherit;False;FourGrid;-1;;54;41b9b931f65e2694f970b9e5e8ab4f5d;0;4;1;COLOR;1,0,0,0;False;2;COLOR;1,1,0,0;False;3;COLOR;0,1,0,0;False;4;COLOR;0,0,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;323;-5705.867,-478.0698;Inherit;False;Constant;_Float4;Float 4;25;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;325;-5527.042,-116.658;Inherit;False;Property;_DiffuseUseFourGrid;DiffuseUseFourGrid;3;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;115;935.8678,478.0344;Inherit;False;SRP Additional Light;-1;;53;6c86746ad131a0a408ca599df5f40861;3,6,0,9,0,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;309;-683.3365,59.97184;Inherit;False;Property;_DarkenDiffuseGrayscale;DarkenDiffuseGrayscale;26;0;Create;True;0;0;False;0;False;0.05;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;308;223.6636,-24.02815;Inherit;False;Property;_DarkMask;DarkMask;19;0;Create;False;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;192;-5189.42,-538.1324;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;117;-2222.733,370.2986;Inherit;False;Property;_EmissionColor;Emission Color;12;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;77;-3763.61,-744.9214;Inherit;False;Property;_FlipNormal;FlipNormal;13;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;288;-3786.677,-1224.423;Inherit;False;Property;_DarkMask;DarkMask;24;0;Create;False;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;113;-3009.957,458.0205;Inherit;False;Property;_ObjectCenterWS;ObjectCenterWS;14;0;Create;True;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-2640,1776;Inherit;False;Property;_FloorAOIntensity;FloorAOIntensity;23;0;Create;True;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;196;-2798.397,1562.254;Inherit;True;Global;FloorAO;FloorAO;22;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;89;-1323.908,-108.2155;Inherit;False;Property;_Specular;Specular;8;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-1685.297,52.6149;Inherit;False;Property;_SpecularIntensity;SpecularIntensity;9;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;330;-6284.042,92.34204;Inherit;False;Property;_SW;SW;7;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-3063.921,1268.943;Inherit;False;Property;_VerticalAORadius;VerticalAO Radius;20;0;Create;True;0;0;False;0;False;0.3;0;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;170;-2463.925,1254.943;Inherit;False;Property;_VerticalAOIntensity;VerticalAO Intensity;19;0;Create;True;0;0;False;0;False;0.05;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;114;-1378.241,369.5764;Inherit;False;Property;_Emission;Emission;11;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;112;-3001.034,752.1827;Inherit;False;Property;_JSMaxDistance;JSMaxDistance;17;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;328;-6082.042,94.34204;Inherit;False;Property;_SE;SE;6;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;191;-6164.686,-364.19;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;118;-1649.963,393.2635;Inherit;False;Property;_JellySubsurface;JellySubsurface;15;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;324;3;329;0
WireConnection;324;4;328;0
...
WireConnection;192;1;322;0
WireConnection;192;2;325;0
...
ASEEND*/
//CHKSM=C7CC36748CDBF4D2E7DC7070014F9ACF75032D31