	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv06_g58 = float4(IN.ase_texcoord8.xy,0,0).xy * float2( 1,1 ) + float2( 0,0 );
				float2 break7_g58 = uv06_g58;
				float temp_output_8_0_g58 = step( break7_g58.x , 0.5 );
				float temp_output_9_0_g58 = step( break7_g58.y , 0.5 );
				float temp_output_10_0_g58 = ( 1.0 - temp_output_9_0_g58 );
				float temp_output_11_0_g58 = ( 1.0 - temp_output_8_0_g58 );
				#ifdef _DIFFUSEUSEFOURGRID_ON
				float4 staticSwitch325 = ( ( temp_output_8_0_g58 * temp_output_10_0_g58 * _NW ) + ( temp_output_11_0_g58 * temp_output_10_0_g58 * _NE ) + ( temp_output_11_0_g58 * temp_output_9_0_g58 * _SE ) + ( temp_output_8_0_g58 * temp_output_9_0_g58 * _SW ) );
				#else
				...
				float3 WorldPosition8_g57 = WorldPosition;
				float3 localAdditionalLightsFlat8_g57 = AdditionalLightsFlat( WorldPosition8_g57 );
				#ifdef _EMISSION_ON
				...
				float3 Color = ( ( DarkenDiffuse310 + DarkenSpecular314 + localAdditionalLightsFlat8_g57 + DarkenEmission269 ) * AO216 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=18200
0;6;2560;1373;7473.986;1399.808;1.3;True;False
...
Node;AmplifyShaderEditor.FunctionNode;331;-5817.042,-7.657959;Inherit;False;FourGrid;-1;;58;41b9b931f65e2694f970b9e5e8ab4f5d;0;4;1;COLOR;1,0,0,0;False;2;COLOR;1,1,0,0;False;3;COLOR;0,1,0,0;False;4;COLOR;0,0,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StaticSwitch;194;-1596.458,1574.993;Inherit;False;Property;_FloorAO;Floor AO;18;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;115;935.8678,478.0344;Inherit;False;SRP Additional Light;-1;;57;6c86746ad131a0a408ca599df5f40861;3,6,0,9,0,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=9533C571F25DB7F002422C36272CF842E15218C7