	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 staticSwitch322 = tex2D( _DiffuseTex, uv0191 );
				#else
				float4 staticSwitch322 = temp_cast_0;
				#endif
				float4 temp_cast_1 = (1.0).xxxx;
				float2 uv06_g54 = float4(IN.ase_texcoord8.xy,0,0).xy * float2( 1,1 ) + float2( 0,0 );
				float2 break7_g54 = uv06_g54;
				float temp_output_8_0_g54 = step( break7_g54.x , 0.5 );
				float temp_output_11_0_g54 = ( 1.0 - temp_output_8_0_g54 );
				float temp_output_9_0_g54 = step( break7_g54.y , 0.5 );
				float temp_output_10_0_g54 = ( 1.0 - temp_output_9_0_g54 );
				#ifdef _DIFFUSEUSEFOURGRID_ON
				float4 staticSwitch325 = ( ( temp_output_11_0_g54 * temp_output_10_0_g54 * _NW ) + ( temp_output_8_0_g54 * temp_output_10_0_g54 * _NE ) + ( temp_output_8_0_g54 * temp_output_9_0_g54 * _SE ) + ( temp_output_11_0_g54 * temp_output_9_0_g54 * _SW ) );
				#else
				float4 staticSwitch325 = temp_cast_1;
				#endif
				float4 Albedo315 = ( _Diffuse * staticSwitch322 * staticSwitch325 );
				float3 Diffuse221 = ( ( ( LightAtten74 * NdotL66 ) + bakedGI85 ) * (Albedo315).rgb );
				float lerpResult320 = lerp( 0.8 , 1.0 , NdotL66);
				float3 temp_cast_2 = (( _DarkenDiffuseGrayscale * lerpResult320 )).xxx;
				float3 lerpResult317 = lerp( temp_cast_2 , Diffuse221 , DarkMask285);
				#ifdef _DARKMASK_ON
				...
				#ifdef _DARKMASK_ON
				float3 staticSwitch312 = temp_cast_3;
				#else
				float3 staticSwitch312 = Specular225;
				#endif
				float3 DarkenSpecular314 = staticSwitch312;
				float3 WorldPosition8_g55 = WorldPosition;
				float3 localAdditionalLightsFlat8_g55 = AdditionalLightsFlat( WorldPosition8_g55 );
				#ifdef _EMISSION_ON
				...
				float3 Color = ( ( DarkenDiffuse310 + DarkenSpecular314 + localAdditionalLightsFlat8_g55 + DarkenEmission269 ) * AO216 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=18200
0;6;2560;1373;4695.122;698.3952;1.548633;True;False
...
Node;AmplifyShaderEditor.SamplerNode;196;-2798.397,1562.254;Inherit;True;Global;FloorAO;FloorAO;19;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;211;-2640,1776;Inherit;False;Property;_FloorAOIntensity;FloorAOIntensity;20;0;Create;True;0;0;False;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;170;-2463.925,1254.943;Inherit;False;Property;_VerticalAOIntensity;VerticalAO Intensity;16;0;Create;True;0;0;False;0;False;0.05;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-3063.921,1268.943;Inherit;False;Property;_VerticalAORadius;VerticalAO Radius;17;0;Create;True;0;0;False;0;False;0.3;0;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;194;-1596.458,1574.993;Inherit;False;Property;_FloorAO;Floor AO;18;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;276;-5236.427,-1030.819;Inherit;True;Global;DarkMaskTex;DarkMaskTex;21;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;115;935.8678,478.0344;Inherit;False;SRP Additional Light;-1;;55;6c86746ad131a0a408ca599df5f40861;3,6,0,9,0,23,0;5;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-683.3365,59.97184;Inherit;False;Property;_DarkenDiffuseGrayscale;DarkenDiffuseGrayscale;22;0;Create;True;0;0;False;0;False;0.05;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;117;-1775.722,391.5253;Inherit;False;Property;_EmissionColor;Emission Color;12;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=02E3DE731EAEAAFE204DC075AE0A92105A6E97A4