...
Shader "MicroUniverse/Lit"
{
	Properties
	{
		...
		_AttenFalloff("AttenFalloff", Range( 0 , 1)) = 0.2
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 LightAtten74 = ( _MainLightColor.rgb * ase_lightAtten );
				...
				half3 staticSwitch149 = ( ( ddx( WorldPosition ) + ddy( WorldPosition ) ) * _dWSIntensity );
				#else
				half3 staticSwitch149 = float3( 0,0,0 );
				#endif
				half3 temp_output_103_0 = ( ( ( ( ( ( ( 1.0 - _AttenFalloff ) * NdotL66 ) * LightAtten74 ) + ( _AttenFalloff * NdotL66 ) ) + bakedGI85 ) * (_Diffuse).rgb ) + staticSwitch89 + localAdditionalLightsFlat8_g53 + staticSwitch114 + staticSwitch149 );
				half temp_output_173_0 = ( WorldPosition.y * WorldPosition.y );
				#ifdef _FLOORAO_ON
				half3 staticSwitch168 = ( temp_output_103_0 * ( 1.0 - ( ( 1.0 - ( temp_output_173_0 / ( temp_output_173_0 + _FloorAORadius ) ) ) * _FloorAOIntensity ) ) );
				#else
				half3 staticSwitch168 = temp_output_103_0;
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = staticSwitch168;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18200
514.6667;340;1906;1039;2880.58;651.8594;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;167;-1711.849,1682.037;Inherit;False;1352.548;401.8029;FloorAO (+Y w/ Quadratic Atten);9;176;173;170;181;169;180;178;171;174;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;53;-1329.948,-522.5112;Inherit;False;985.5187;380.488;Diffuse;6;109;101;100;85;71;184;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.StaticSwitch;168;354.3646,1548.963;Inherit;False;Property;_FloorAO;Floor AO;14;0;Create;True;0;0;False;0;False;1;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;171;-1619.828,1965.685;Inherit;False;Property;_FloorAORadius;FloorAO Radius;16;0;Create;True;0;0;False;0;False;0.1;0;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;170;-1019.828,1951.685;Inherit;False;Property;_FloorAOIntensity;FloorAO Intensity;15;0;Create;True;0;0;False;0;False;0.5705882;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-2550.604,-438.9374;Inherit;False;Property;_AttenFalloff;AttenFalloff;7;0;Create;True;0;0;False;0;False;0.2;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;183;112.8155,1471.442;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;184;-1295.481,-418.7;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;86;-1819.953,-347.4485;Inherit;False;74;LightAtten;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;190;-2166.58,-448.8594;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;109;-856.2225,-315.1075;Inherit;False;Property;_Diffuse;Diffuse;0;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;-1542.457,-506.507;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;185;-1929.481,-464.7;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;107;-2104.847,-343.4093;Inherit;False;66;NdotL;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;188;-2213.481,-141.7;Inherit;False;66;NdotL;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;189;-2000.481,-216.7;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
