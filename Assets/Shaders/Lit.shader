	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#endif
				float3 temp_output_103_0 = ( ( ( ( LightAtten74 * NdotL66 ) + bakedGI85 ) * (( _Diffuse * tex2D( _DiffuseTex, uv0191 ) )).rgb ) + staticSwitch89 + localAdditionalLightsFlat8_g53 + staticSwitch114 + staticSwitch149 );
				float temp_output_173_0 = ( WorldPosition.y * WorldPosition.y );
				#ifdef _FLOORAO_ON
				float3 staticSwitch168 = ( temp_output_103_0 * ( 1.0 - ( ( 1.0 - ( temp_output_173_0 / ( temp_output_173_0 + _FloorAORadius ) ) ) * _FloorAOIntensity ) ) );
				#else
				float3 staticSwitch168 = temp_output_103_0;
				#endif
...
/*ASEBEGIN
Version=18200
0;0;2560;1379;2685.58;789.8594;1;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;77;-4469.293,-309.9915;Inherit;False;Property;_FlipNormal;FlipNormal;7;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=EAC7FDCA485FBA70D6CBEA12A4FDAD80406393E2