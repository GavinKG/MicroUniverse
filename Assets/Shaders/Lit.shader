	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				#endif
				float3 temp_output_103_0 = ( ( ( ( ( temp_output_96_0 + ( ( 1.0 - temp_output_96_0 ) * NdotL66 ) ) * LightAtten74 ) + bakedGI85 ) * (_Diffuse).rgb ) + staticSwitch89 + localAdditionalLightsFlat8_g53 + staticSwitch114 + staticSwitch149 );
...
/*ASEBEGIN
Version=18200
0;0;2560;1379;5942.712;939.8515;4.022324;True;False
...
ASEEND*/
//CHKSM=9960D70C088FD9F52299F05A88B641781E13C8BE