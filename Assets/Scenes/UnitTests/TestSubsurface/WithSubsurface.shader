...
Shader "WithSubsurface"
{
	Properties
	{
		...
		_SubsurfaceColor("SubsurfaceColor", Color) = (1,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 Subsurface( float3 lightColor , float NdotL , float3 normalWS , float3 subsurfaceColor , float subsurfaceRadius )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float3 temp_output_81_0_g7 = (0.0).xxx;
				...
				float3 tanNormal117_g7 = float3(0,0,1);
				float3 worldNormal117_g7 = normalize( float3(dot(tanToWorld0,tanNormal117_g7), dot(tanToWorld1,tanNormal117_g7), dot(tanToWorld2,tanNormal117_g7)) );
				float dotResult124_g7 = dot( _MainLightPosition.xyz , worldNormal117_g7 );
				float ase_lightAtten = 0;
				Light ase_lightAtten_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_lightAtten_mainLight.distanceAttenuation * ase_lightAtten_mainLight.shadowAttenuation;
				float3 temp_output_107_0_g7 = ( _MainLightColor.rgb * ase_lightAtten );
				float3 bakedGI143_g7 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, ase_worldNormal);
				float3 WorldPosition8_g8 = WorldPosition;
				float3 localAdditionalLightsFlat8_g8 = AdditionalLightsFlat( WorldPosition8_g8 );
				float3 lightColor151_g7 = _MainLightColor.rgb;
				float NdotL151_g7 = dotResult124_g7;
				float3 normalWS151_g7 = worldNormal117_g7;
				float3 subsurfaceColor151_g7 = _SubsurfaceColor.rgb;
				float subsurfaceRadius151_g7 = max( _radius , 0.0 );
				float3 localSubsurface151_g7 = Subsurface( lightColor151_g7 , NdotL151_g7 , normalWS151_g7 , subsurfaceColor151_g7 , subsurfaceRadius151_g7 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( ( ( ( temp_output_81_0_g7 + ( ( 1.0 - temp_output_81_0_g7 ) * dotResult124_g7 ) ) * temp_output_107_0_g7 ) + bakedGI143_g7 ) * _BaseColor.rgb ) + float3( 0,0,0 ) + localAdditionalLightsFlat8_g8 + localSubsurface151_g7 );
				float Alpha = 1;
...
/*ASEBEGIN
Version=18200
462;72.66667;1669;1287;1205.874;581.154;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;7;-621.374,188.346;Inherit;False;Property;_radius;radius;0;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;6;-761.5,-41.5;Inherit;False;Property;_BaseColor;BaseColor;1;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;8;-794.374,-256.654;Inherit;False;Property;_SubsurfaceColor;SubsurfaceColor;2;0;Create;True;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;11;-353.5,9.5;Inherit;False;MicroUniverseLightingModel;-1;;7;0fd6531708adcfd4c87a8ba343e6afa7;3,144,0,146,0,150,1;7;153;COLOR;1,1,1,0;False;154;FLOAT;1;False;108;FLOAT3;0,0,0;False;120;FLOAT3;0,0,0;False;113;FLOAT;0;False;121;FLOAT;0;False;84;FLOAT;0;False;1;FLOAT3;65
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;WithSubsurface;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;7;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;21;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;Meta Pass;0;DOTS Instancing;0;Extra Pre Pass;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;5;False;True;True;True;False;False;;0
...
WireConnection;11;153;8;0
WireConnection;11;154;7;0
WireConnection;11;108;6;0
WireConnection;1;2;11;65
ASEEND*/
//CHKSM=B9C6E509FCCA3AA913B42DE1A56EC570BEEFD9DA